...
//-----------------------------------------------------------------------------
// name: x-network-osx.h
// desc: general network and http routines (OSX)
//
// authors: Ge Wang (ge@ccrma.stanford.edu)
//          Jieun Oh (jieun5@ccrma.stanford.edu)
//    date: Spring 2010
//-----------------------------------------------------------------------------
#ifndef __MCD_X_NETWORK_H__
#define __MCD_X_NETWORK_H__
...
//-----------------------------------------------------------------------------
// name: struct SMHttpPostResult
// desc: http post result
//-----------------------------------------------------------------------------
struct XHttpPostResult
{
	SInt32 responseCode;
	CFMutableDataRef resultData;
    bool isCompressed;
};

// http post
XHttpPostResult * XHttpPost( CFStringRef url, CFDataRef postData, 
                             bool * shouldAbort = NULL );
// release result
